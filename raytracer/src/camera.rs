...
use crate::vec3::Vec3;
use crate::{ray::Ray, vec3::{random_in_unit_disk, random_in_unit_sphere}};
...
impl Camera{
    pub fn new(lookfrom:Vec3,lookat:Vec3,vup:Vec3,vfov:f64,aspect_ratio:f64,aperture:f64,focus_dist:f64) -> Self{
        ...
        Self{
            ...
            lower_left_corner : lookfrom - u_ * viewpoint_width * focus_dist / 2.0  - v_ * viewpoint_height * focus_dist / 2.0 -  w_ * focus_dist,
