...
use crate::{Vec3, rtweekend::{random_double, random_double2, random_int}};
...
impl Perlin{
    pub fn new() -> Self{
        ...
        for i in 0..POINT_COUNT {
            ...
            ranv[i] = Vec3::unit(Vec3::new(random_double2(-1.0, 1.0),random_double2(-1.0, 1.0),random_double2(-1.0, 1.0)))
        }
            ...
            for dj in 0..2{
                for dk in 0..2{
                    c[di][dj][dk] = self.ranvec[
                        (self.perm_x[((i as i32 + di as i32) & 255) as usize] as i32^
        ...
        for i in 0..2{
            for j in 0..2{
                for k in 0..2{
                    ...
                    (k as f64 * ww + (1.0 - k as f64) * (1.0 - ww)) * Vec3::dot(c[i][j][k],Vec3::new(u - i as f64, v - j as f64, w - k as f64));
                }
            }
        }
        acc
